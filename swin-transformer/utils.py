...
def read_fixed_split_data(train_root: str, val_root: str):
    ...
    def load_images_and_labels(root):
        ...
        for class_name in class_names:
            ...
            for ext in [".jpg", ".JPG", ".png", ".PNG"]:
                ...
                images_path.extend(files)
                images_label.extend([class_indices[class_name]] * len(files))
        return images_path, images_label

    train_images_path, train_images_label = load_images_and_labels(train_root)
    val_images_path, val_images_label = load_images_and_labels(val_root)

    print(f"Total training images: {len(train_images_path)}")
    print(f"Total validation images: {len(val_images_path)}")
