...
def test_img():
    # 训练好的模型权重路径
    model = YOLO("E:/pythonCode/yolov8_20231122/ultralytics-main/runs/detect/v8bide/weights/best.pt")
    # 测试图片的路径
    img = cv2.imread("E:/pythonCode/yolov8_20231122/ultralytics-main/vitiligo_detection03/images/val/img_t_10_0014-jpg_flipped_horizontal_jpg.rf.29fe740bbe8987a534b57d151e621cf9.jpg")
    res = model(img)
    ann = res[0].plot()
    while True:
        cv2.imshow("yolo", ann)
