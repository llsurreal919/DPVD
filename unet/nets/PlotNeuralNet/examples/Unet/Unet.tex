...
\def\AttnColor{rgb:green,2;red,2;white,4}
...
\pic[shift={(1.0,0,0)}] at (cr5-east) {RightBandedBox={name=attn5,%
		zlabel=I/16,fill=\AttnColor,bandfill=\AttnColor,%
		height=8,width=1,depth=8}};

 \node at ($(cr5-east)!0.5!(attn5-west)$) {$\odot$};
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Draw Decoder 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% unpool4, 
\pic[shift={(1.2,0,0)}] at (attn5-east) {Box={name=up4,%
...
\pic[shift={(0,0,0)}] at (cat4-east) {RightBandedBox={name=ucr4a,%
        xlabel={{"512","512"}},zlabel=I/8,fill=\ConvColor,bandfill=\ConvReluColor,%
        height=16,width={6,6},depth=16}};
\pic[shift={(1.0,0,0)}] at (ucr4a-east) {RightBandedBox={name=attn4,%
    		zlabel=I/8,fill=\AttnColor,bandfill=\AttnColor,%
    		height=16,width=1,depth=16}};
    	
\node at ($(ucr4a-east)!0.5!(attn4-west)$) {$\odot$};
%%%%%%%%%%
%% unpool3, 
\pic[shift={(1.5,0,0)}] at (attn4-east) {Box={name=up3,%
...
\pic[shift={(0,0,0)}] at (cat3-east) {RightBandedBox={name=ucr3a,%
        xlabel={{"256","256"}},zlabel=I/4,fill=\ConvColor,bandfill=\ConvReluColor,%
        height=25,width={4.5,4.5},depth=25}};
\pic[shift={(1.0,0,0)}] at (ucr3a-east) {RightBandedBox={name=attn3,%
    		zlabel=I/4,fill=\AttnColor,bandfill=\AttnColor,%
    		height=25,width=1,depth=25}};
 \node at ($(ucr3a-east)!0.5!(attn3-west)$) {$\odot$};
%%%%%%%%%%
%% unpool2, 
\pic[shift={(1,0,0)}] at (attn3-east) {Box={name=up2,%
...
\pic[shift={(0,0,0)}] at (cat2-east) {RightBandedBox={name=ucr2a,%
        xlabel={{"128","128"}},zlabel=I/2,fill=\ConvColor,bandfill=\ConvReluColor,%
        height=32,width={3.5,3.5},depth=32}};
\pic[shift={(1.0,0,0)}] at (ucr2a-east) {RightBandedBox={name=attn2,%
    		zlabel=I/2,fill=\AttnColor,bandfill=\AttnColor,%
    		height=32,width=1,depth=32}};
  \node at ($(ucr2a-east)!0.5!(attn2-west)$) {$\odot$};
%%%%%%%%%%
%% unpool1, 
\pic[shift={(1.5,0,0)}] at (attn2-east) {Box={name=up1,%
...
\draw [connection]  (attn5-east)   -- node {\midarrow} (up4-west);
\draw [connection]  (attn4-east) -- node {\midarrow} (up3-west);
\draw [connection]  (attn3-east) -- node {\midarrow} (up2-west);
\draw [connection]  (attn2-east) -- node {\midarrow} (up1-west);
