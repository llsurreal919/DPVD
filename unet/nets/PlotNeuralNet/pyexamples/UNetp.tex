...
\def\AttentionColor{rgb:green,1;black,3}
...
\begin{document}
	\begin{tikzpicture}
		...
		\pic[shift={(0,0,0)}] at (ucr4-east) {RightBandedBox={name=attention4,%
				xlabel={{"Attention",""}},fill=\AttentionColor,bandfill=\ConvReluColor,%
				height=16,width=6,depth=16}};    
		\pic[shift={(0,0,0)}] at (attention4-east) {RightBandedBox={name=ucr4a,%
				xlabel={{"512","512"}},zlabel=I/8,fill=\ConvColor,bandfill=\ConvReluColor,%
				height=16,width={6,6},depth=16}};
		%%%%%%%%%%
		%% unpool3, 
		...
		\pic[shift={(0,0,0)}] at (ucr3-east) {RightBandedBox={name=attention3,%
				xlabel={{"Attention",""}},fill=\AttentionColor,bandfill=\ConvReluColor,%
				height=25,width=4.5,depth=25}};
		\pic[shift={(0,0,0)}] at (attention3-east) {RightBandedBox={name=ucr3a,%
				xlabel={{"256","256"}},zlabel=I/4,fill=\ConvColor,bandfill=\ConvReluColor,%
				height=25,width={4.5,4.5},depth=25}};
		%%%%%%%%%%
		%% unpool2, 
		...
		\pic[shift={(0,0,0)}] at (ucr2-east) {RightBandedBox={name=attention2,%
				xlabel={{"Attention",""}},fill=\AttentionColor,bandfill=\ConvReluColor,%
				height=32,width=3.5,depth=32}};    
		\pic[shift={(0,0,0)}] at (attention2-east) {RightBandedBox={name=ucr2a,%
				xlabel={{"128","128"}},zlabel=I/2,fill=\ConvColor,bandfill=\ConvReluColor,%
				height=32,width={3.5,3.5},depth=32}};
		%%%%%%%%%%
		%% unpool1, 
		...
		\pic[shift={(0,0,0)}] at (ucr1-east) {RightBandedBox={name=attention1,%
				xlabel={{"Attention",""}},fill=\AttentionColor,bandfill=\ConvReluColor,%
				height=40,width=2.5,depth=40}};  
		\pic[shift={(0,0,0)}] at (attention1-east) {RightBandedBox={name=ucr1a,%
